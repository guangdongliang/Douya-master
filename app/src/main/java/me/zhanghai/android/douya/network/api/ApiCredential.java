...
interface ApiCredential {
    ...
    interface Frodo {
       String KEY = HackyApiCredentialHelper.loadStringFromFile(new File(Environment.getExternalStorageDirectory(), "Douya/API_KEY"));
        String SECRET = HackyApiCredentialHelper.loadStringFromFile(new File(Environment.getExternalStorageDirectory(), "Douya/API_SECRET"));
